            ...
            try {
                switch ($blk) {
                    ...
                    case 1: /* --- debug breakpoint for line 1 --- */
                        ...
                        console.log('$loadlist153 =', $loadlist153);
                        $loc.tab = window.currentPythonRunner.reportValue(Sk.builtin.persistentCopy($loc.tab, $loadlist153), '$loc.tab');
                    ...
                    case 2: /* --- debug breakpoint for line 3 --- */
                        ...
                        ;console.log('$loadname155 =', $loadname155);
                    ...
                    case 4: /* --- debug breakpoint for line 5 --- */
                        ...
                        ;console.log('$loadname157 =', $loadname157);
                    ...
                    case 5: /* --- function return or resume suspension --- */
                        ...
                        var $lsubscr158 = $ret;
                        console.log('$lsubscr158 =', $lsubscr158);
                    ...
                    case 12: /* --- function return or resume suspension --- */
                        ...
                        var $next161 = $ret;
                        console.log('$next161 =', $next161);
                        if ($next161 === undefined) {
                            $blk = 10;
                            continue;
                        }
                        $loc.num = window.currentPythonRunner.reportValue(Sk.builtin.persistentCopy($loc.num, $next161), '$loc.num');
                        if (Sk.breakpoints('<stdin>.py', 7, 0)) {
                            var $susp = $saveSuspension({
