            ...
            try {
                switch ($blk) {
                    ...
                    case 4:
                        ...
                        $blk = 3; /* allowing case fallthrough */
                    case 3:
                        /* --- done --- */ var $jfalse152 = ($compareres149 === false || !Sk.misceval.isTrue($compareres149));
                    ...
                    case 5:
                        ...
                        $blk = 2; /* allowing case fallthrough */
                    case 2:
                        /* --- end of if --- */ if (Sk.breakpoints('<stdin>.py', 4, 4)) {
                        var $susp = $saveSuspension({
                            data: {
                                type: 'Sk.debug'
                            },
                    ...
                    case 8:
                        /* --- done --- */ var $jfalse155 = ($compareres153 === false || !Sk.misceval.isTrue($compareres153));
                    ...
                    case 7:
                        /* --- end of if --- */ if (Sk.breakpoints('<stdin>.py', 6, 4)) {
                        var $susp = $saveSuspension({
                            data: {
                                type: 'Sk.debug'
                            },
