...
$compiledmod = function () {
    ...
    var $scope162 = (function $test163$(c) {
        ...
        var $saveSuspension = function ($child, $filename, $lineno, $colno) {
            ...
            susp.$tmps = {"c": c, "v": v, "$lsubscr167": $lsubscr167};
            return susp;
        };
            ...
            try {
                switch ($blk) {
                    ...
                    case 2: /* --- debug breakpoint for line 11 --- */
                        ...
                        Sk.builtin.changeReferences($loc, a);
                        var $__correspondences__ = Sk.builtin.changeReferences($gbl, a);
                        debugger;
