...
import {renderValue, renderArrow, getVariables} from './utils';
    ...
    return (
      <DirectiveFrame {...this.props} hasFullView>
        <div className='clearfix' style={{padding: '2px'}}>
          <SvgPan width='100%' height={svgHeight} scale={scale} x={cellPan * (BAR_WIDTH + BAR_SPACING) - 10} y={0} getPosition={this.getPosition} onPan={this.onPan} >
