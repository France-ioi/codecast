            ...
            (<div className="controls controls-stepper">
                {showControls && <React.Fragment>
                  ...
                  <div className="big-buttons">
                    ...
                    {controlsType === StepperControlsType.Normal && <div className="speed-slider is-extended">
                    ...
                    {controlsType === StepperControlsType.StepByStep && <div className="small-buttons is-extended">
