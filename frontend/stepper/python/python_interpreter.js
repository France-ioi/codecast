...
export default function (context) {
    ...
    this._skulptifyHandler = (name, generatorName, blockName, nbArgs, type) => {
        if (!arrayContains(this._definedFunctions, name)) {
            this._definedFunctions.push(name);
        }
    ...
    this.reportValue = (origValue, varName) => {
        ...
        let value = this.unSkulptValue(origValue);
        let highlighted = $('.aceHighlight');
        let target = null;
