...
class _AnalysisVariableValue extends React.PureComponent<AnalysisVariableValueProps> {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                {null !== this.props.old && this.props.cur !== this.props.old ?
...
export const AnalysisVariableValue = connect(null, mapDispatchToProps)(_AnalysisVariableValue);
