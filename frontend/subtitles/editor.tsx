...
import {formatTimeLong, postJson} from '../common/utils';
...
function* subtitlesEditorEnterSaga({actionTypes, views}, _action) {
    ...
    yield put({
        ...
        payload: {controls: {top: [views.PlayerControls], floating: [views.SubtitlesEditorReturn]}}
    });
...
class SubtitlesEditor extends React.PureComponent<SubtitlesEditorProps> {
    _loadInput = null;
...
class SubtitlesEditorOption extends React.PureComponent<SubtitlesEditorOptionProps> {
    render() {
...
class SubtitlesEditorNewOption extends React.PureComponent<SubtitlesEditorNewOptionProps> {
    render() {
...
interface SubtitlesEditorReturnProps {
    dispatch: Function,
    subtitlesEditorReturn: string
}

class SubtitlesEditorReturn extends React.PureComponent<SubtitlesEditorReturnProps> {
    render() {
...
function SubtitlesEditorPaneSelector(state, props) {
    ...
    const {
        ...
        subtitlesItemShifted, playerSeek
    } = state.get('actionTypes');
