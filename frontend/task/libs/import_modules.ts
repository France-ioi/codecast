...
export async function importPlatformModules(platform, modulesPath) {
    ...
    const modulesToImport = {
        blockly: ['fonts-loader-1.0', 'acorn', 'acorn-walk', 'interpreter', 'blockly', 'blockly_blocks', 'blockly_javascript', 'blockly_python', 'blockly_fioi', 'quickAlgo_utils', 'quickAlgo_i18n'],
