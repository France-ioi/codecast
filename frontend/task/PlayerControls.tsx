...
export function PlayerControls() {
    ...
    useEffect(() => {
        ...
        function handleClickOutside(event) {
            const excludedClasses = '.bp6-portal, .bp6-portal *, .subtitles-band, .subtitles-band *, .subtitles-pane-container, .subtitles-pane-container *, .editor-footer, .editor-footer *';
