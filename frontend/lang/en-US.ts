export default {
    ...
    PROGRAM_CANNOT_BE_MODIFIED_WHILE_RUNNING: "The program cannot be modified while it is running.",
    START_PLAYBACK: "play",
    ...
    RECORDING_LIBRARY_NOT_WORKING: "Warning, this library is not compatible with Codecast recordings.",
    ...
    TASK_LEVEL_SUCCESS_SHOW_SOLUTION_INCITATIVE: "We recommend that you read the solution carefully, even if you did not have any difficulty with the exercise. You will often find advice there that may prove very useful to you later on.",
    TASK_LEVEL_SUCCESS_SHOW_SOLUTION: "Read the correction",
    ...
    TASK_CLIENT_TESTS_SUCCESS: "Your program works on the example tests. Would you like to validate your answer?",
    TASK_CLIENT_TESTS_SUCCESS_YES: "Validate my answer",
    TASK_BLOCKS_TITLE: "Available blocks",
    TASK_BLOCKS_SUBTITLE: "Click to insert",
    TASK_BLOCKS_COLLAPSE: "Collapse blocks",
    TASK_BLOCKS_EXPAND: "Expand blocks",
    ...
    TASK_ERROR_CLOSE: "Close the error",
    ...
    TRALALERE_HINTS_ASK: "Request a hint",
    ...
    HINTS_CODE_HELP_LIB_DEFINITION: "The \"{library}\" module has the following available methods:",
    ...
    COPIED: "Copied!",
    GIT_REPOSITORY: "URL of the Git repository (SSH)",
    GIT_BRANCH: "Branch of the Git repository",
    GIT_ERROR_BRANCHES: "Impossible to fetch the branches for this Git repository, please check its access rights.",
    GIT_ERROR_REPOSITORY_FORMAT: "Invalid format: use the URL of the Git repository in SSH format (starting with git@...)",
    GIT_ERROR_CONTENT: "Impossible to fetch the content of this folder.",
    GIT_ERROR_PULL: "An error has occurred while fetching this file.",
    GIT_ERROR_PUSH: "An error has occurred while sending this file.",
