export default {
    ...
    MENU_SYNC_GIT: "Travailler sur Git",
    ...
    TASK_LEVEL_SUCCESS_STAY_LEVEL_BUTTON: "Rester sur la question actuelle",
    ...
    TASK_LEVEL_SUCCESS_FINISHED: "Félicitations, vous avez entièrement résolu cette question !",
    TASK_LEVEL_SUCCESS_FINISHED_FAMILIAR: "Félicitations, tu as entièrement résolu cette question !",
    ...
    TASK_LEVEL_SUCCESS_SHOW_SOLUTION_INCITATIVE: "Nous vous recommandons de lire bien attentivement la correction et ce même si le sujet ne vous a pas posé de problème. Vous y trouverez souvent des conseils qui pourront vous être très utiles par la suite.",
    TASK_LEVEL_SUCCESS_SHOW_SOLUTION: "Lire la correction",
    ...
    TASK_BLOCKS_COLLAPSE: "Replier les blocs",
    TASK_BLOCKS_EXPAND: "Ouvrir les blocs",
    ...
    TASK_ERROR_CLOSE: "Fermer l'erreur",
    ...
    SUBMISSION_EXECUTE_ON_SERVER: "serveur d'évaluation",
    SUBMISSION_EXECUTE_ON_REMOTE_DEBUG_SERVER: "serveur de debug",
    ...
    COPIED: "Copié !",
    GIT_REPOSITORY: "URL du dépôt Git (SSH)",
    GIT_BRANCH: "Branche du dépôt Git",
    GIT_BRANCH_NO_RESULT: 'Aucun résultat',
    GIT_ERROR_BRANCHES: "Impossible de récupérer les branches de ce dépôt, merci de vérifier les droits d'accès.",
    GIT_ERROR_REPOSITORY_FORMAT: "Format invalide : utilisez l'URL du dépôt Git au format SSH (commençant par git@...)",
    GIT_ERROR_CONTENT: "Impossible de récupérer le contenu de ce dossier.",
    GIT_ERROR_PULL: "Une erreur s'est produite pendant la récupération de ce fichier.",
    GIT_ERROR_PUSH: "Une erreur s'est produite pendant l'envoi de votre version du fichier.",
