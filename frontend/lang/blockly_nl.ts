...
FioiBlockly.Msg.DICTS_CREATE_EMPTY_TITLE = 'leeg woordenboek';
FioiBlockly.Msg.DICTS_CREATE_WITH_CONTAINER_TITLE_ADD = 'Een woordenboek maken';
FioiBlockly.Msg.DICTS_CREATE_WITH_CONTAINER_TOOLTIP = '';
FioiBlockly.Msg.DICTS_CREATE_WITH_INPUT_WITH = 'Een woordenboek maken';
FioiBlockly.Msg.DICTS_CREATE_WITH_ITEM_KEY = 'sleutel';
FioiBlockly.Msg.DICTS_CREATE_WITH_ITEM_MAPPING = '';
FioiBlockly.Msg.DICTS_CREATE_WITH_ITEM_TITLE = 'sleutel/waarde';
FioiBlockly.Msg.DICTS_CREATE_WITH_ITEM_TOOLTIP = '';
FioiBlockly.Msg.DICTS_CREATE_WITH_TOOLTIP = '';
FioiBlockly.Msg.DICT_GET = 'de sleutel ophalen';
FioiBlockly.Msg.DICT_GET_TO = 'van';
FioiBlockly.Msg.DICT_KEYS = 'lijst van de sleutels van';
FioiBlockly.Msg.DICT_SET_TITLE = 'de sleutel toewijzen';
FioiBlockly.Msg.DICT_SET_OF = 'van het woordenboek';
FioiBlockly.Msg.DICT_SET_TO = 'aan';
FioiBlockly.Msg.TEXT_PRINT_TITLE = 'de regel weergeven %1';
FioiBlockly.Msg.TEXT_PRINT_TOOLTIP = 'De tekst, het getal of een andere opgegeven waarde weergeven, gevolgd door een regeleinde.';
FioiBlockly.Msg.TEXT_PRINT_NOEND_TITLE = 'weergeven %1';
FioiBlockly.Msg.TEXT_PRINT_NOEND_TOOLTIP = 'De tekst, het getal of een andere opgegeven waarde weergeven, zonder regeleinde.';
FioiBlockly.Msg.TEXT_EVAL_TITLE = 'evalueren';
FioiBlockly.Msg.TEXT_EVAL_TOOLTIP = 'Evalueert de opgegeven rekenkundige bewerking.';
FioiBlockly.Msg.TEXT_EVAL_INVALID = "Opgelet : %1 ; dit blok zal terugkeren 'fout' !";
FioiBlockly.Msg.EVAL_ERROR_SEMICOLON = "de puntkomma ';' is niet toegestaan";
FioiBlockly.Msg.EVAL_ERROR_SYNTAX = 'de uitdrukking is syntactisch niet geldig';
FioiBlockly.Msg.EVAL_ERROR_TYPE = 'dit type uitdrukking (%1) is niet toegestaan';
FioiBlockly.Msg.EVAL_ERROR_VAR = "deze uitdrukking gebruikt een ongedefinieerde '%1' variabele";
FioiBlockly.Msg.LISTS_APPEND_MSG = 'voeg element %2 toe aan lijst %1';
FioiBlockly.Msg.LISTS_APPEND_TOOLTIP = "Voeg een element toe aan de lijst '%1'";
FioiBlockly.Msg.LISTS_CREATE_WITH_TOO_LARGE = 'Lijstgrootte te groot: %1 > maximaal toegestane grootte %2';
FioiBlockly.Msg.LISTS_GET_INDEX_FIRST = 'in het begin';
FioiBlockly.Msg.LISTS_GET_INDEX_FROM_END = 'aan de index vanaf het einde ';
FioiBlockly.Msg.LISTS_GET_INDEX_FROM_START = 'aan de index  ';
FioiBlockly.Msg.LISTS_GET_INDEX_GET = 'de waarde bekomen';
FioiBlockly.Msg.LISTS_GET_INDEX_GET_REMOVE = 'de waarde bekomen en wissen';
FioiBlockly.Msg.LISTS_GET_INDEX_LAST = 'op het einde';
FioiBlockly.Msg.LISTS_GET_INDEX_RANDOM = 'naar een willekeurige hint';
FioiBlockly.Msg.LISTS_GET_INDEX_REMOVE = 'de waarde wissen';
FioiBlockly.Msg.LISTS_SET_INDEX_INSERT = 'invoegen';
FioiBlockly.Msg.LISTS_SORT_TITLE = 'stuur het gesorteerde terug %1 %2 van de lijst %3';
FioiBlockly.Msg.LISTS_SORT_PLACE_MSG = 'de lijst sorteren %1 ter plaatse';
FioiBlockly.Msg.LISTS_SORT_PLACE_TOOLTIP = "Sorteer de lijst ' %1' en wijzig ze onmiddellijk.";
FioiBlockly.Msg.INPUT_NUM = 'één enkel getal op één regel lezen';
FioiBlockly.Msg.INPUT_NUM_TOOLTIP = 'Leest één enkel getal op één regel, op de programma-invoer.';
FioiBlockly.Msg.INPUT_NUM_LIST = 'een lijst met getallen op één regel lezen';
FioiBlockly.Msg.INPUT_NUM_LIST_TOOLTIP = 'Leest een lijst getallen op één regel, uit de programma-invoer.';
FioiBlockly.Msg.INPUT_NUM_NEXT = 'een getal lezen';
FioiBlockly.Msg.INPUT_NUM_NEXT_TOOLTIP = 'Leest het volgende getal op de programma-invoer.';
FioiBlockly.Msg.INPUT_CHAR = 'Een karakter lezen';
FioiBlockly.Msg.INPUT_CHAR_TOOLTIP = 'Leest een karakter op de programma-invoer.';
FioiBlockly.Msg.INPUT_WORD = 'een woord lezen';
FioiBlockly.Msg.INPUT_WORD_TOOLTIP = 'Leest een woord op de programma-invoer.';
FioiBlockly.Msg.INPUT_LINE = 'een regel lezen';
FioiBlockly.Msg.INPUT_LINE_TOOLTIP = 'Leest een regel op de programma-invoer.';
FioiBlockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE = "Variabele '%1', gebruikt door procedure '%2', kan niet worden verwijderd.";
FioiBlockly.Msg.DATA_REPLACEITEMOFLIST_TITLE = 'vervang het element %1 in lijst %2 door %3';
FioiBlockly.Msg.DATA_ITEMOFLIST_TITLE = 'element %1 in %2';
FioiBlockly.Msg.DATA_LISTREPEAT_TITLE = 'initialiseer lijst %1 met %2 herhaald %3 keer';
FioiBlockly.Msg.INVALID_NAME = "Ongeldige naam, gebruik alleen letters, letters met Franse accenten, cijfers (behalve als eerste teken) en underscore '_'.";
FioiBlockly.Msg.TABLES_2D_INIT = 'initialiseer de 2D-tabel %1 met %2 rijen en %3 kolommen die %4 bevatten';
FioiBlockly.Msg.TABLES_2D_INIT_TOOLTIP = 'Creëer een tabel met het opgegeven aantal rijen en kolommen en initialiseer elk veld met de opgegeven waarde.';
FioiBlockly.Msg.TABLES_2D_SET = 'in %1[%2] [%3] zet %4';
FioiBlockly.Msg.TABLES_3D_SET_TOOLTIP = 'Zet de waarde in het veld [laag] [rij] [kolom] in de tabel %1.';
FioiBlockly.Msg.TABLES_2D_GET = '%1[%2] [%3]';
FioiBlockly.Msg.TABLES_2D_GET_TOOLTIP = 'Haal de waarde op uit het veld [rij] [kolom] in de tabel %1.';
FioiBlockly.Msg.TABLES_3D_INIT = 'initialiseer de 3D-tabel %1 met %2 lagen, %3 rijen, %4 kolommen met %5';
FioiBlockly.Msg.TABLES_3D_INIT_TOOLTIP = 'Creëer een tabel met het opgegeven aantal rijen, kolommen en niveaus en initialiseer elk veld met de opgegeven waarde.';
FioiBlockly.Msg.TABLES_3D_SET = 'in %1[%2] [%3] [%4] zet %5';
FioiBlockly.Msg.TABLES_3D_GET = '%1[%2] [%3] [%4]';
FioiBlockly.Msg.TABLES_3D_GET_TOOLTIP = 'Haal de waarde op uit het vak [laag] [rij] [kolom] in de tabel %1.';
FioiBlockly.Msg.TABLES_VAR_NAME = 'tabel';
FioiBlockly.Msg.TABLES_TOO_BIG = 'Afmetingen van de tabel te groot!';
FioiBlockly.Msg.TABLES_OUT_OF_BOUNDS = 'Poging tot toegang tot een veld buiten de tabel!';
FioiBlockly.Msg.MATH_DIVISIONFLOOR_SYMBOL = '//';
FioiBlockly.Msg.MATH_ARITHMETIC_TOOLTIP_DIVIDEFLOOR = 'Geeft het gehele getal van de deling van de twee getallen.';
