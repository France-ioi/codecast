...
FioiBlockly.Msg.DICTS_CREATE_EMPTY_TITLE = "dictionnaire vide";
FioiBlockly.Msg.DICTS_CREATE_WITH_CONTAINER_TITLE_ADD = "Créer un dictionnaire";
FioiBlockly.Msg.DICTS_CREATE_WITH_CONTAINER_TOOLTIP = "";
FioiBlockly.Msg.DICTS_CREATE_WITH_INPUT_WITH = "créer un dictionnaire :";
FioiBlockly.Msg.DICTS_CREATE_WITH_ITEM_KEY = "cle";
FioiBlockly.Msg.DICTS_CREATE_WITH_ITEM_MAPPING = ":";
FioiBlockly.Msg.DICTS_CREATE_WITH_ITEM_TITLE = "clé/valeur";
FioiBlockly.Msg.DICTS_CREATE_WITH_ITEM_TOOLTIP = "";
FioiBlockly.Msg.DICTS_CREATE_WITH_TOOLTIP = "";
FioiBlockly.Msg.DICT_GET = "récupérer la clé";
FioiBlockly.Msg.DICT_GET_TO = "de";
FioiBlockly.Msg.DICT_KEYS = "liste des clés de";
FioiBlockly.Msg.DICT_SET_TITLE = "affecter la clé";
FioiBlockly.Msg.DICT_SET_OF = "du dictionnaire";
FioiBlockly.Msg.DICT_SET_TO = "à";

FioiBlockly.Msg.TEXT_PRINT_TITLE = "afficher la ligne %1";
FioiBlockly.Msg.TEXT_PRINT_TOOLTIP = "Afficher le texte, le nombre ou une autre valeur spécifiée, avec retour à la ligne après.";
FioiBlockly.Msg.TEXT_PRINT_NOEND_TITLE = "afficher %1";
FioiBlockly.Msg.TEXT_PRINT_NOEND_TOOLTIP = "Afficher le texte, le nombre ou une autre valeur spécifiée, sans retour à la ligne.";

FioiBlockly.Msg.TEXT_EVAL_TITLE = "évaluer";
FioiBlockly.Msg.TEXT_EVAL_TOOLTIP = "Évalue l'expression arithmétique spécifiée.";
FioiBlockly.Msg.TEXT_EVAL_INVALID = "Attention : %1 ; ce bloc retournera 'faux' !";

FioiBlockly.Msg.TEXT_STR_TITLE = "convertir en texte %1";
FioiBlockly.Msg.TEXT_STR_TOOLTIP = "Convertir une valeur en texte.";

FioiBlockly.Msg.EVAL_ERROR_SEMICOLON = "le point-virgule ';' n'est pas autorisé";
FioiBlockly.Msg.EVAL_ERROR_SYNTAX = "l'expression n'est pas syntaxiquement valide";
FioiBlockly.Msg.EVAL_ERROR_TYPE = "ce type d'expression (%1) n'est pas autorisé";
FioiBlockly.Msg.EVAL_ERROR_VAR = "cette expression utilise une variable '%1' non définie";

FioiBlockly.Msg.LISTS_APPEND_MSG = "à la liste %1 ajouter l'élément %2";
FioiBlockly.Msg.LISTS_APPEND_TOOLTIP = "Ajouter un élément à la liste '%1'";
FioiBlockly.Msg.LISTS_CREATE_WITH_TOO_LARGE = "Taille de la liste trop grande : %1 > taille maximale autorisée %2"
FioiBlockly.Msg.LISTS_GET_INDEX_FIRST = "au début";
FioiBlockly.Msg.LISTS_GET_INDEX_FROM_END = "à l'indice depuis la fin";
FioiBlockly.Msg.LISTS_GET_INDEX_FROM_START = "à l'indice";
FioiBlockly.Msg.LISTS_GET_INDEX_GET = "obtenir la valeur";
FioiBlockly.Msg.LISTS_GET_INDEX_GET_REMOVE = "obtenir et supprimer la valeur";
FioiBlockly.Msg.LISTS_GET_INDEX_LAST = "à la fin";
FioiBlockly.Msg.LISTS_GET_INDEX_RANDOM = "à un indice aléatoire";
FioiBlockly.Msg.LISTS_GET_INDEX_REMOVE = "supprimer la valeur";
FioiBlockly.Msg.LISTS_SET_INDEX_INSERT = "insérer";
FioiBlockly.Msg.LISTS_SORT_TITLE = "renvoyer le tri %1 %2 de la liste %3"
FioiBlockly.Msg.LISTS_SORT_PLACE_MSG = "trier la liste %1 sur place";
FioiBlockly.Msg.LISTS_SORT_PLACE_TOOLTIP = "Trie la liste '%1' et la modifie directement.";

FioiBlockly.Msg.INPUT_NUM = "lire un nombre seul sur une ligne";
FioiBlockly.Msg.INPUT_NUM_TOOLTIP = "Lit un nombre seul sur une ligne, sur l'entrée du programme.";
FioiBlockly.Msg.INPUT_NUM_LIST = "lire une liste de nombres sur une ligne";
FioiBlockly.Msg.INPUT_NUM_LIST_TOOLTIP = "Lit une liste de nombres sur une ligne, sur l'entrée du programme.";
FioiBlockly.Msg.INPUT_NUM_NEXT = "lire un nombre";
FioiBlockly.Msg.INPUT_NUM_NEXT_TOOLTIP = "Lit le prochain nombre sur l'entrée du programme.";
FioiBlockly.Msg.INPUT_CHAR = "lire un caractère";
FioiBlockly.Msg.INPUT_CHAR_TOOLTIP = "Lit un caractère sur l'entrée du programme.";
FioiBlockly.Msg.INPUT_WORD = "lire un mot";
FioiBlockly.Msg.INPUT_WORD_TOOLTIP = "Lit un mot sur l'entrée du programme.";
FioiBlockly.Msg.INPUT_LINE = "lire une ligne";
FioiBlockly.Msg.INPUT_LINE_TOOLTIP = "Lit une ligne sur l'entrée du programme.";

FioiBlockly.Msg.CANNOT_DELETE_VARIABLE_PROCEDURE = "Impossible de supprimer la variable '%1', utilisée par la procédure '%2'.";

FioiBlockly.Msg.DATA_REPLACEITEMOFLIST_TITLE = "remplacer l'élément %1 de la liste %2 par %3";
FioiBlockly.Msg.DATA_ITEMOFLIST_TITLE = "élément %1 dans %2";
FioiBlockly.Msg.DATA_LISTREPEAT_TITLE = "initialiser la liste %1 avec %2 répété %3 fois";

FioiBlockly.Msg.INVALID_NAME = "Nom invalide, veuillez n'utiliser que des lettres, lettres accentuées françaises, chiffres (sauf comme premier caractère) et tiret bas '_'.";

FioiBlockly.Msg.TABLES_2D_INIT = "initialiser le tableau 2D %1 avec %2 lignes et %3 colonnes contenant %4";
FioiBlockly.Msg.TABLES_2D_INIT_TOOLTIP = "Crée un tableau avec le nombre spécifié de lignes et de colonnes, et initialise chaque case à la valeur donnée.";
FioiBlockly.Msg.TABLES_2D_SET = "dans %1[%2] [%3] mettre %4";
FioiBlockly.Msg.TABLES_3D_SET_TOOLTIP = "Met la valeur dans la case [ligne] [colonne] du tableau %1.";
FioiBlockly.Msg.TABLES_2D_GET = "%1[%2] [%3]";
FioiBlockly.Msg.TABLES_2D_GET_TOOLTIP = "Récupère la valeur dans la case [ligne] [colonne] du tableau %1.";

FioiBlockly.Msg.TABLES_3D_INIT = "initialiser le tableau 3D %1 avec %2 couches, %3 lignes, %4 colonnes contenant %5";
FioiBlockly.Msg.TABLES_3D_INIT_TOOLTIP = "Crée un tableau avec le nombre spécifié de lignes, de colonnes et de niveaux, et initialise chaque case à la valeur donnée.";
FioiBlockly.Msg.TABLES_3D_SET = "dans %1[%2] [%3] [%4] mettre %5";
FioiBlockly.Msg.TABLES_3D_SET_TOOLTIP = "Met la valeur dans la case [couche] [ligne] [colonne] du tableau %1.";
FioiBlockly.Msg.TABLES_3D_GET = "%1[%2] [%3] [%4]";
FioiBlockly.Msg.TABLES_3D_GET_TOOLTIP = "Récupère la valeur dans la case [couche] [ligne] [colonne] du tableau %1.";

FioiBlockly.Msg.TABLES_VAR_NAME = "tableau";
FioiBlockly.Msg.TABLES_TOO_BIG = "Dimensions du tableau trop grandes !";
FioiBlockly.Msg.TABLES_OUT_OF_BOUNDS = "Tentative d'accès à une case hors du tableau !";

FioiBlockly.Msg.VARIABLES_SET = "dans %1 mettre %2";

FioiBlockly.Msg.MATH_DIVISIONFLOOR_SYMBOL = ' // ';
FioiBlockly.Msg.MATH_ARITHMETIC_TOOLTIP_DIVIDEFLOOR = "Renvoie la partie entière de la division des deux nombres.";
