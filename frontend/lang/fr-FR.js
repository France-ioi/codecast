module.exports = {
    ...
    COPIED: "Copié !",
    GIT_REPOSITORY: "URL du répertoire Git (SSH)",
    GIT_BRANCH: "Branche du répertoire Git",
    GIT_BRANCH_NO_RESULT: 'Aucun résultat',
    GIT_ERROR_BRANCHES: "Impossible de récupérer les branches de ce répertoire, merci de vérifier les droits d'accès.",
    GIT_ERROR_REPOSITORY_FORMAT: "Format invalide : utilisez l'URL du répertoire Git au format SSH (commençant par git@...)",
