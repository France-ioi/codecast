...
export const documentFromString = function (text) {
  return new Document(new Immutable.List(text.split('\n')));
};
...
Document.prototype.applyDelta = function (delta) {
...
Document.prototype.endCursor = function () {
  if (this.lines.size === 0) {
